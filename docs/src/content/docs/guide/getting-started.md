...
description: Install python2ts and start transpiling Python to TypeScript.
---
...
- [Syntax Reference](/python2ts/reference/syntax) - Complete Python to TypeScript transformation rules
- [Runtime Library](/python2ts/reference/runtime) - Detailed documentation for all pythonlib modules
