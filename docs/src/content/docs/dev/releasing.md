...
description: How to release new versions of python2ts and pythonlib
---

This project uses [Release Please](https://github.com/googleapis/release-please) for automated releases and npm Trusted Publishing (OIDC) for secure package publishing.
