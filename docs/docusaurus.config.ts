    ...
    [
      "docusaurus-plugin-typedoc",
      {
        entryPoints: [
          ...
          "../packages/pythonlib/src/pathlib.ts",
          "../packages/pythonlib/src/glob.ts",
          "../packages/pythonlib/src/shutil.ts",
          "../packages/pythonlib/src/tempfile.ts",
          "../packages/pythonlib/src/subprocess.ts",
          "../packages/pythonlib/src/urllib.ts",
          "../packages/pythonlib/src/logging.ts"
        ],
